...
- [ClawBench](https://github.com/TIGER-AI-Lab/ClawBench) - Evaluates browser-agent model-plus-harness systems on 283 live-site tasks with isolated runs and five-layer execution traces.
